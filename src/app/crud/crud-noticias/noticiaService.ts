...
export class ClienteService {
    ...
    private registros: IRegistro[] =
        [{ id: "1", titulo: "BRIAR OP", link: "www.lol.es"},
        { id: "2", titulo: "AATROX OP", link: "www.lol.es"},
        { id: "3", titulo: "XERATH OP", link: "www.lol.es"},
        { id: "4", titulo: "ZYRA OP", link: "www.lol.es"},
        { id: "5", titulo: "KHA'ZIX OP", link: "www.lol.es"}]
    ...
    actualizarServicio(id:string,reg:IRegistro){
        ...
        let found = this.registros.find((elementoHarrys) => elementoHarrys.id == id);
