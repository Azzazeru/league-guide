...
@Component({
    ...
    templateUrl: './campeon-edit.page.html',
    //styleUrls: ['./cliente.actualizar.page.scss'],
})
export class CampeonEditPage implements OnInit {
    // FormGroup para validaciones
    productForm!: FormGroup;
    // Esquema a utilizar en el Html
    producto: ClProducto = { id: 1, nombre: '', titulo: '', fechaDeSalida: '' };
    id: any = '';
            ...
            .subscribe({
                next: (data) => {
                    ...
                    this.productForm.setValue({
                        ...
                        prod_desc: data.titulo,
                        prod_fecha: data.fechaDeSalida
                    });
                    loading.dismiss();
                },
                complete: () => { },
