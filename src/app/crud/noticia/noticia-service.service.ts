...
const apiUrl = "http://localhost:3000/noticia";
...
export class ProductServiceService {
  ...
  addProduct(noticia: ClProducto): Observable<ClProducto> {
    console.log("Res-api Enviando AddProducto : ",noticia);
    // Ojo No lo ejecuta lo declara
    // El Pipe lo intercepta
    return this.http.post<ClProducto>(apiUrl, noticia, httpOptions)
      .pipe(  // Tubería
         // tap intersecta la respuesta si no hay error
        tap((producto: ClProducto) => console.log('added product w/:',noticia)),
