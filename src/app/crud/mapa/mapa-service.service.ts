...
const apiUrl = "http://localhost:3000/mapa";
...
export class ProductServiceService {
  ...
  addProduct(mapa: ClProducto): Observable<ClProducto> {
    console.log("Res-api Enviando AddProducto : ",mapa);
    // Ojo No lo ejecuta lo declara
    // El Pipe lo intercepta
    return this.http.post<ClProducto>(apiUrl, mapa, httpOptions)
