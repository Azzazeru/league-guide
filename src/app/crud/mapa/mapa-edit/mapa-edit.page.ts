...
import { ClProducto } from '../model/ClMapa';
import { ProductServiceService } from '../mapa-service.service';

@Component({
  selector: 'app-mapa-edit',
  templateUrl: './mapa-edit.page.html',
  styleUrls: ['./mapa-edit.page.scss'],
})
export class MapaEditPage implements OnInit {

  // FormGroup para validaciones
  productForm!: FormGroup;
  // Esquema a utilizar en el Html
  producto: ClProducto = { id: 1, nombreMapa: '', descripcion: ''};
  id: any = '';
